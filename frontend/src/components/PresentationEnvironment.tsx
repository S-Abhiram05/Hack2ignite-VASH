              ...
              <div className="details-grid-2">
                ...
                <div className="info-box">
                  ...
                  <p className="db-effect-desc">
                    Upon threat index threshold breach ({activeTx.risk.toFixed(4)} &ge; 0.75), VASH ACID manager automatically rerouted table row insertion from <code>public.transactions</code> to isolated <code>quarantine.suspended_ledgers</code>.
                  </p>
...
-- ACID Status: ${activeTx.dbStatus.tableState}`}
  ...
  SignedByEnclave: "VASH-PQC-HSM-VAULT"
}`}
                  </div>
                </div>
              </div>
