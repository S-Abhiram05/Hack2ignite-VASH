                        ...
                        <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="col-span-full space-y-2">
                                    ...
                                    <input type="url" className="w-full bg-white/60 border border-[#121212]/10 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#006C67]/40" placeholder="https://api.yourbank.com/vash-alerts" />
                                </div>
                            </div>
                    ...
                    {step === 2 && (
                        <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                            ...
                            <div className="bg-[#121212] p-6 rounded-2xl font-mono text-sm text-green-400 border border-white/10 shadow-2xl">
                                <p className="mb-2"><span className="text-white">$</span> pip install vash-edge-agent</p>
                                <p className="text-white/40 italic"># Initialize edge agent on your on-premise hardware</p>
                                <p className="mt-4"><span className="text-white">$</span> vash --init --node-id GTB-01</p>
                            </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 bg-orange-500/10 border border-orange-500/30 rounded-xl flex items-start gap-3 text-left">
                                        ...
                                        <p className="text-[11px] font-bold text-orange-700 leading-tight">
                                            IMPORTANT: Store this in your Hardware Security Module (HSM). VASH will never store or transmit this key again. Loss of this key means loss of telemetry history.
                                        </p>
                                    </div>
