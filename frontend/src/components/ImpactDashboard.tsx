      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
        <div className="max-w-2xl">
          ...
          <p className="text-[#FF4F00]/60 font-medium text-lg leading-relaxed">
            Real-time visual quantification of VASH's defensive posture across the federated banking network.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-3">
          <BentoCard
            ...
            subtitle="Detected mathematically via PSI (Private Set Intersection) without exposing raw customer PII to the central VASH kernel."
