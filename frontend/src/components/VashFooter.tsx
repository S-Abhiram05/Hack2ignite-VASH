        ...
        <footer className="bg-gradient-to-b from-[#0A1F18] to-[#040A08] mt-24 py-16 px-6 border-t border-white/10 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center relative z-10">
                <div className="mb-8 md:mb-0">
                    <h2 className="text-3xl font-['Playfair_Display'] text-white tracking-[0.2em] mb-2 font-bold">VASH</h2>
                ...
                <div className="flex flex-col md:items-end space-y-4">
                    <div className="flex space-x-6">
                        ...
                        <a 
                            href="http://instagram.com/vash.sec" 
                            target="_blank" 
                    ...
                    <div className="pt-6 border-t border-white/10 w-full md:w-auto text-left md:text-right">
                        <p className="text-xs text-slate-500 font-mono tracking-wider">
                            ...
                            <span className="text-slate-300 font-bold ml-0 md:ml-2 text-sm text-orange-500/80">Vineet &bull; Abhiram &bull; Sakshi &bull; Himanshu</span>
                        </p>
                        <p className="text-xs text-slate-600 mt-2">&copy; {new Date().getFullYear()} VASH Platform. All signals monitored.</p>
                    </div>
                </div>
            </div>
