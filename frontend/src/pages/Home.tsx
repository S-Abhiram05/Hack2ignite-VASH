                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
                        ...
                        <GlowCard glowColor="purple" className="p-8 w-full h-full shadow-none border-none" customSize={true}>
                            ...
                            <p className="text-[#121212]/80 font-medium leading-relaxed">
                                Sophisticated deep-learning models that dynamically adjust weights based on emerging fraud patterns, ensuring VASH stays ahead of evolving smurfing tactics.
                            </p>
                        </GlowCard>
                    </div>
                </div>
