...
const BankLogin = () => {
    ...
    const handleInitialLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError("Network error. Please ensure the VASH Neural API is running.");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const handleMfaVerify = (e: React.FormEvent) => {
        ...
        if (mfaCode.length === 18) {
            setIsLoading(true);
            setTimeout(() => {
                localStorage.setItem('vash_token', tempAuthData.access_token);
                        ...
                        {view === 'submitted' && (
                            ...
                            >
                                ...
                                <p className="text-sm font-medium text-[#121212]/70 leading-relaxed mb-8">
                                    Your registration request for VASH API access has been forwarded to the Central Bank Authority for verification. 
