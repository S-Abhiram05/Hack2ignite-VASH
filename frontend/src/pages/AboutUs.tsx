            ...
            <div className="max-w-6xl w-full flex flex-col items-center">
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-[#121212]/70 max-w-2xl mx-auto font-medium leading-relaxed italic">
                        "To break the silos of modern banking. VASH provides edge-powered, cryptographic threat intelligence, allowing financial institutions to collaboratively destroy multi-hop money laundering networks without compromising user privacy."
                    </p>
                </motion.div>
