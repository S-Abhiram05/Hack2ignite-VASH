            ...
            <div className="pqc-hero-comparison">
              ...
              <div className="hero-box border-green">
                <div className="hero-title">
                  ...
                  <span>VASH DEFENSE: HIGH-DIMENSIONAL LATTICE CRYPTOGRAPHY</span>
                </div>
                <p>
                  VASH implements NIST-standardized <strong>Learning With Errors (LWE)</strong> over polynomial rings (R_q). Even Quantum Computers cannot find the shortest vector in 1000-dimensional vector lattices (NP-Hard problem).
                </p>
            ...
            <div className="visual-diagram-card">
              ...
              <div className="diagram-grid-3">
                <div className="diag-step">
                  ...
                  <p>
                    Adversaries intercepting traffic today cannot store and decrypt data in 2030+. VASH wraps data in <strong>CRYSTALS-Kyber1024</strong> KEM envelopes.
                  </p>
                </div>
